...
$(function(){$(".top-line .sf-menu").superfish({delay:200});$(".carousel-services").owlCarousel({loop:!0,center:!0,navContainer:".slide-content",items:1,itemClass:"slide-wrap",nav:!0,navSpeed:700,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>']}),$(".sf-menu").clone().removeClass("sf-menu").appendTo("#my-menu");var e=$("#my-menu").mmenu({extensions:["fx-menu-slide","fx-panels-slide-up","fx-listitems-drop","fullscreen","listview-huge","pagedim-black"],autoHeight:!0,offCanvas:{position:"right"},navbar:{title:"Меню сайта:"},clone:!0}),i=$(".hamburger"),n=e.data("mmenu");i.on("click",function(){n.open()}),i.on("click",function(){n.close()}),n.bind("open:finish",function(){setTimeout(function(){i.addClass("is-active")},100)}),n.bind("close:finish",function(){setTimeout(function(){i.removeClass("is-active")},100)}),$(".service-item h4").equalHeights(),$(".link-item").equalHeights(),$(".popup-with-zoom-anim").magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-zoom-in"})});